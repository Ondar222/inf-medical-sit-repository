    ...
    return (
        <div className="font-mono [&>p]:py-1">
            <p>Просим Вас внимательно ознакомиться с порядком приема и рассмотрения обращений,
                направленных в адрес Инфекционной Больницы.</p>
            <p>Обращения, поступившие в адрес Инфекционной Больницы,
            ...
            <p>Вы можете направить обращение в Инфекционную Больницу:</p>
            <p>- путем заполнения соответствующей формы, размещенной на официальном сайте</p>
            <p>- путём его направления на почтовый или электронный адрес Инфекционной Больницы</p>
            <p>- путем звонка по телефону приемной Инфекционной Больницы</p>

            <p>1. Обращения, направленные в форме электронного документа через официальный сайт, поступают на
                рассмотрение в Инфекционную Больницу и рассматриваются
                работниками
                Инфекционной Больницы.</p>
