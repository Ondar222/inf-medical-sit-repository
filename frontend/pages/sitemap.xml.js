...
const EXTERNAL_DATA_URL = 'http://inf-medical.rtyva.ru';
...
function generateSiteMap(posts, about, activity, civilservice) {
  return `<?xml version="1.0" encoding="UTF-8"?>
   <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
     ...
     <url>
       <loc>http://inf-medical.rtyva.ru.rtyva.ru</loc>
     </url>
     <url>
       <loc>http://inf-medical.rtyva.ru.rtyva.ru/management</loc>
     </url>
     <url>
       <loc>http://inf-medical.rtyva.ru/contacts</loc>
     </url>
     <url>
       <loc>http://inf-medical.rtyva.ru/sendrequest</loc>
     </url>
     <url>
       <loc>http://inf-medical.rtyva.ru/civilservice</loc>
     </url>
    ...
    return `
      ...
      .join('')}
     <url>
       <loc>http://inf-medical.rtyva.ru/news</loc>
     </url>
     ${posts.map(({ id }) => {
        return `
       <url>
     ...
     `;
      ...
      .join('')}
      <url>
        <loc>http://inf-medical.rtyva.ru/about</loc>
      </url>
      ${about.map(({ title }) => {
        return `
        <url>
      ...
      .join('')}
      <url>
        <loc>http://inf-medical.rtyva.ru/activity</loc>
      </url>
      ${activity.map(({ title }) => {
        return `
        <url>
