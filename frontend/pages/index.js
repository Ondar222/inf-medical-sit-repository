...
const Home = ({ news, page, pageSize, pageCount, total, links }) => {
    ...
    return (
        <MainPageLayout>
            ...
            <div className="w-5/5 relative flex xs:flex-col md:flex-row">
                <Carousel slider={links.slider} />
            </div>
            <div className="w-full flex flex-row gap-3" >
                <div className="xs:w-full sm:w-5/5 md:w-5/5 lg:w-full">
                ...
                {/* <div className="xs:hidden md:hidden lg:flex xs:flex-row md:flex-col gap-3 justify-start xs:w-full md:w-1/5 min-w-40">
